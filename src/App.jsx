    ...
    return (
        <div className="p-32 flex flex-col font-sans-pro items-center justify-center min-h-screen">
            ...
            <div className="mt-32 flex flex-row w-full space-x-8 items-stretch justify-center">
                <button className="flex hover:bg-cyan-700/20 flex-col text-left w-1/3 p-5 border-2 border-cyan-700 rounded-xl hover:scale-110 transition duration-200">
                ...
                <button className="flex flex-col w-1/3 p-5 hover:bg-cyan-700/20 text-left border-cyan-700 border-2 rounded-xl hover:scale-110 transition duration-200">
                ...
                <button className="flex flex-col w-1/3 p-5 text-left hover:bg-cyan-700/20 border-cyan-700 border-2 rounded-xl hover:scale-110 transition duration-200">
                    <AiFillFileAdd
                        size="100px"
